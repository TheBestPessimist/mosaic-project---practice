...
public class TestScaler {
	...
	public static void main(String[] args) throws Exception {
		...
		Plot plot = new Plot();
		String[] types = new String[]{"medium"};
		
		String method=COMPARE_METHOD.UCSB.toString();
		
		for (String type : types) {
			
			double data[] = PreprocessData.readHistoryFile("results/neprocesate-in/" + type + ".txt");
			...
			boolean exists = false;
				...
				for (int windowSize = 2; windowSize < 40; windowSize++) {			
				...
				for (int windowHistory = 3; windowHistory < 40; windowHistory++) 
				...
				for (int windowSize = 2; windowSize < 15; windowSize++) 
